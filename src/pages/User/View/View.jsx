...
const View = () => {
  ...
  <IonPage>
	...
	<IonHeader>
      ...
      <IonSlides className="IonSlides" pager={true}>
        <IonSlide >
         <div line="none" className="mainDiv ion-margin-bottom" >
         	<p className="headerContent">
       		...
       		<img src="https://picsum.photos/536/354" className="slideImg"/>
         </div> 
        <IonItem lines="none">
        ...
        <IonSlide >
         <div line="none" className="mainDiv ion-margin-bottom" >
         	<p className="headerContent">
       		...
       		<img src="https://picsum.photos/536/355" className="slideImg"/>
         </div> 
        <IonItem lines="none">
         <IonLabel className="leftContent">    
           <span className="contentDivCommentTxt">256</span>  <IonIcon className="smallIcons" slot="end" icon={chatboxOutline}> 98</IonIcon>             
        ...
        <IonSlide >
         <div line="none" className="mainDiv ion-margin-bottom" >
         	<p className="headerContent">
       		...
       		<img src="https://picsum.photos/536/356" className="slideImg"/>
         </div> 
        <IonItem lines="none">
         <IonLabel className="leftContent">    
           <span className="contentDivCommentTxt">256</span>  <IonIcon className="smallIcons" slot="end" icon={chatboxOutline}> 98</IonIcon>             
